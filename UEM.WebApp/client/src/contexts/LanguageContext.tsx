...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    assets_agent_based: "Assets (Agent-Based)",
    assets_agentless: "Assets (Agentless)",
    discovery_scheduled: "Discovery (Scheduled)",
    discovery_scripts_alt: "Discovery Scripts (Alt)",
    discovery_scripts_main: "Discovery Scripts (Main)",
    policies_alt: "Policies (Alt)",
    scripts_marketplace: "Scripts Marketplace",
    satellite_job_queue: "Satellite Job Queue",
    enterprise_cred_profiles: "Enterprise Credential Profiles",
    asset_inventory_page: "Asset Inventory Page",
    agentless_job_wizard: "Create Agentless Job",
    alerts_page: "Alerts & Notifications",
    reports_page: "Reports",
    i18n_demo: "i18n Demo",
    simple_i18n_demo: "Simple i18n Demo",
  ...
  es: {
    ...
    others: "Otros",
    assets_page: "Página de Activos",
    assets_agent_based: "Activos (Basado en Agente)",
    assets_agentless: "Activos (Sin Agente)",
    discovery_scheduled: "Descubrimiento (Programado)",
    discovery_scripts_alt: "Scripts de Descubrimiento (Alt)",
    discovery_scripts_main: "Scripts de Descubrimiento (Principal)",
    policies_alt: "Políticas (Alt)",
    scripts_marketplace: "Mercado de Scripts",
    satellite_job_queue: "Cola de Trabajos Satélite",
    enterprise_cred_profiles: "Perfiles de Credenciales Empresariales",
    asset_inventory_page: "Página de Inventario de Activos",
    agentless_job_wizard: "Crear Trabajo sin Agente",
    alerts_page: "Alertas y Notificaciones",
    reports_page: "Informes",
    i18n_demo: "Demo i18n",
    simple_i18n_demo: "Demo i18n Simple",
  ...
  fr: {
    ...
    others: "Autres",
    assets_page: "Page des Actifs",
    assets_agent_based: "Actifs (Basé sur Agent)",
    assets_agentless: "Actifs (Sans Agent)",
    discovery_scheduled: "Découverte (Planifiée)",
    discovery_scripts_alt: "Scripts de Découverte (Alt)",
    discovery_scripts_main: "Scripts de Découverte (Principal)",
    policies_alt: "Politiques (Alt)",
    scripts_marketplace: "Marché de Scripts",
    satellite_job_queue: "File d'Attente de Tâches Satellite",
    enterprise_cred_profiles: "Profils de Références d'Entreprise",
    asset_inventory_page: "Page d'Inventaire des Actifs",
    agentless_job_wizard: "Créer Tâche sans Agent",
    alerts_page: "Alertes et Notifications",
    reports_page: "Rapports",
    i18n_demo: "Démo i18n",
    simple_i18n_demo: "Démo i18n Simple",
  ...
  de: {
    ...
    others: "Andere",
    assets_page: "Assets-Seite",
    assets_agent_based: "Assets (Agent-basiert)",
    assets_agentless: "Assets (Ohne Agent)",
    discovery_scheduled: "Erkennung (Geplant)",
    discovery_scripts_alt: "Erkennungs-Skripte (Alt)",
    discovery_scripts_main: "Erkennungs-Skripte (Haupt)",
    policies_alt: "Richtlinien (Alt)",
    scripts_marketplace: "Skript-Marktplatz",
    satellite_job_queue: "Satelliten-Auftragswarteschlange",
    enterprise_cred_profiles: "Unternehmens-Anmeldeinformationsprofile",
    asset_inventory_page: "Asset-Inventar-Seite",
    agentless_job_wizard: "Agentenlosen Auftrag Erstellen",
    alerts_page: "Warnungen und Benachrichtigungen",
    reports_page: "Berichte",
    i18n_demo: "i18n Demo",
    simple_i18n_demo: "Einfache i18n Demo",
